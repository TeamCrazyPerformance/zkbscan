    ...
    persist(
      (set) => ({
        navList: [
          ...
          { id: 4, name: "ERC 20 top tokens", key: "e2tt" },
          { id: 5, name: "ERC 20 transfer", key: "e2t" },
          { id: 6, name: "NFT top tokens", key: "NFTTT" },
          { id: 7, name: "NFT transfer", key: "NFTT" },
          { id: 8, name: "Daily transaction chart", key: "dtc" },
          { id: 9, name: "TVL chart", key: "dtc" },
        ],
      }),
      {
        name: "navList",
